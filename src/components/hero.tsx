...
const FEATURES = [
  ...
  "Unlimited membership license",
  "Direct line to KrazyJay",
  "Email support",
  "Private music marketing courses",
  "Member-only drops and discounts",
  "Cancel anytime",
];
    ...
    <section id="pricing" className="container mx-auto px-6 py-20">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <h2 className="mt-5 text-4xl md:text-5xl font-black tracking-tight">
          PRIVATE ACCESS. <span className="text-primary">ONE MEMBERSHIP.</span>
        </h2>
      ...
      <div className="mt-14 max-w-xl mx-auto">
        <div className="relative rounded-3xl border border-primary bg-card p-8 md:p-10 shadow-[var(--shadow-glow)]">
          ...
          <p className="mt-3 text-muted-foreground">
            Private access to cinematic, inspirational beats built for artists with a message. Direct line to KrazyJay.
            Cancel anytime.
          </p>
