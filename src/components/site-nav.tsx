    ...
    <header className="absolute left-0 right-0 top-0 z-50">
      <nav className="container mx-auto flex items-center justify-between px-6 py-6">
        <Link to="/" className="text-2xl font-black tracking-tight">
          <span className="text-foreground">MY</span><span className="text-[#e50914]">BEAT</span><span className="text-foreground">CATALOG</span><sup className="ml-0.5 align-super text-[0.45em] font-bold text-foreground">TM</sup>
        </Link>
