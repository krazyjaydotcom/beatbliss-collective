...
begin
  ...
  -- Keep the timer hard for the same email/device, but do not reuse by IP alone.
  -- Families, studios, and offices often share one IP, and should not inherit each other's selected beat.
